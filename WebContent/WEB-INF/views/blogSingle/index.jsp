...
<div class="rating-area">
	<ul class="ratings">
		...
		<li><i class="fa fa-star color"></i> <i class="fa fa-star color"></i>
			<i class="fa fa-star color"></i> <i class="fa fa-star"></i> <i
	...
	<div class="row">
		<div class="col-sm-4">
			...
			<form>
				...
				<span>*</span> <input type="text" placeholder="write your name...">
				<div class="blank-arrow">
